...
#from core.test import im_detect_all_N1 as im_detect_all
from core.test import im_detect_all_realN_subnms as im_detect_all
...
def test_net(
    ...
    """
    #if 'graph' in proposal_file.lower():
    #    as_is = True
    roidb, dataset, start_ind, end_ind, total_num_images = get_roidb_and_dataset(
        dataset_name, proposal_file, ind_range, as_is=as_is
    )
...
def get_roidb_and_dataset(dataset_name, proposal_file, ind_range, as_is):
