...
def get_image_blob(ims, target_scale, target_max_size):
...
#     pdb.set_trace()
    for im in ims:
        ...
        im_list.extend(processed_im)
        scale_list.extend(im_scale)
#     import pdb
#     pdb.set_trace()
    blob = im_list_to_blob(im_list)
#     import pdb
#     pdb.set_trace()
    return blob, scale_list
